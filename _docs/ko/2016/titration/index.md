...
edit_time: 2021-09-06T22:39:20+09:00
...
![1가산用 좌표평면]({{ site.baseurl }}/images/2016/titration/graph.png)
...
![예시]({{ site.baseurl }}/images/2016/titration/newton_edit.png)
...
의 식으로 그래프의 기울기를 구할 수 있는 것이다. 경우에 따라 이 식을 전개한 식은 [방정식 유도 과정](./titration/equation#s-2)에서 찾아볼 수 있다.
